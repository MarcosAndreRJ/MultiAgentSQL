...
**Agente:** `mysql-example`  
**Banco:** `devhacks_site`  
**Gerado em:** 2026-03-24 13:23:38 UTC  
...
### `Dica`
_10 coluna(s). Relacionada a: DicaCategoria, Projeto, Usuario_
**PK:** `idDica`
...
### `DicaCodigo`
_9 coluna(s). Relacionada a: DicaLinguagem, Dica_
**PK:** `idDicaCodigo`
...
### `DicaComentario`
_7 coluna(s). Relacionada a: Usuario, Dica_
**PK:** `idDicaComentario`
...
### `EmpresaDica`
_10 coluna(s). Relacionada a: DicaCategoria, Empresa_
**PK:** `idEmpresaDica`
...
### `ObjetoBD`
_19 coluna(s). Relacionada a: BancoDeDados, Projeto, ProjetoModulo_
**PK:** `idObjetoBD`
...
_9 coluna(s). Relacionada a: ObjetoBDAlteracao, Ambiente_
...
_11 coluna(s). Relacionada a: TarefaCategoria, ProjetoTemplate_
...
_6 coluna(s). Relacionada a: ScriptVersao, Ambiente_
**PK:** `idScriptVersao`
...
### `Scripts`
_9 coluna(s). Relacionada a: BancoDeDados, Projeto, Usuario_
**PK:** `idScripts`
...
### `Tarefa`
_15 coluna(s). Relacionada a: ProjetoModulo, Projeto, TarefaCategoria_
**PK:** `idTarefa`
...
### `TemplateFile`
_11 coluna(s). Relacionada a: Projeto, DicaLinguagem, Usuario_
**PK:** `idTemplateFile`
...
### `TemplateGroup`
_9 coluna(s). Relacionada a: Projeto, Usuario, Empresa_
**PK:** `idTemplateGroup`
...
### `TimeSheetAprovacao`
_25 coluna(s). Relacionada a: ValorHora, Empresa, Projeto_
...
_9 coluna(s). Relacionada a: Usuario, TimeSheet_
...
### `ValorHora`
_11 coluna(s). Relacionada a: Projeto, Usuario, Empresa_
**PK:** `idValorHora`
